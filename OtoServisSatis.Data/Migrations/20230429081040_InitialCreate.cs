        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefon = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", true, new DateTime(2023, 4, 29, 11, 10, 40, 430, DateTimeKind.Local).AddTicks(8067), "admin@otoservisstasi.tc", "admin", 1, "123456", "admin", "8385" });
